...
class ReactQuill extends React.Component<ReactQuillProps, ReactQuillState> {
    ...
    */
    ...
    props that act on the container, rather than the quizzed editing area.
    */
    ...
    */
    ...
    shouldComponentRegenerate(nextProps: ReactQuillProps): boolean {
        // Whenever a `dirtyProp` changes, the editor needs instantiation.
    ...
    */
    renderEditingArea(): React.JSX.Element {
        ...
        const {key, ...otherProps} = properties;
        return preserveWhitespace ?
            <pre key={key} {...otherProps}/> :
